...
const DragAndDropFileUpload = () => {
    ...
    const scrollToBottom = () => {
        if (fileListRef.current) {
            fileListRef.current.scrollIntoView({ behavior: "smooth", block: "end" });
        }
    };
        ...
        <div className="file-upload-container">
            ...
            {files.length > 0 && (
                <div className="file-list">
                    <ul className="prog-list" ref={fileListRef}>
                                ...
                                <div className="file-item">
                                    ...
                                    // color change sky
                                         style={{
                                             ...
                                             backgroundColor: fileObj.error ? "#FCC2C2" : "#d0e2ff"
                                         }}>
                                    </div>
                                    <div className="caption-area">
                                        <h6>{fileObj.file.name}</h6>
                                        {fileObj.error && (
                                            <p className="error-message" style={{ color: '#ff0000', marginTop: '5px' }}>
                                                Error: {fileObj.error}
                                            </p>
                                        )}
                                        <div>
