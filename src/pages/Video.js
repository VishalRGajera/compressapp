      ...
      <div className="block-row">
       <div className="difference">
        <div  className="title-row">
          ...
          <p className="text-left"> Excellent question! Let me give you a side-by-side comparison. Below are two photos of my cousin. The left image is saved as a 64-bit Video directly from Phone. On the right is the same image processed by Compressvideo. Spot any difference? </p>
        </div>
